...
//    System.out.printf("DriveSubsystem.getCurrentSpeeds: %s%n", wheelSpeeds);
    return Constants.DriveConstants.kDriveKinematics.toChassisSpeeds(wheelSpeeds);
  }

  public void resetOdometry(Pose2d pose) {
    m_drivetrainSimulator.setPose(pose);
    System.out.printf("DriveSubsystem.resetOdometry: %s%n", pose);
  ...
  public void arcadeDrive(ChassisSpeeds chassisSpeeds) {
    var wheelSpeeds = Constants.DriveConstants.kDriveKinematics.toWheelSpeeds(chassisSpeeds);
    var leftSpeed = wheelSpeeds.leftMetersPerSecond / Constants.AutoConstants.kMaxSpeedMetersPerSecond;
    var rightSpeed = wheelSpeeds.rightMetersPerSecond / Constants.AutoConstants.kMaxSpeedMetersPerSecond;
